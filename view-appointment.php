...
$sql=mysqli_query($con, 'select Email, Name from tblappointment where ID="$cid"');
...
try {
    ...
    $mail->Username   = 'destination4food@gmail.com';                     //SMTP username
    $mail->Password   = 'ykrdrehmrzzluqwl';                               //SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
    $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

    //Recipients
    $mail->setFrom('destination4food@gmail.com', 'BPMS');
    $mail->addAddress($sql['Email'], $sql['Name']);     //Add a recipient
